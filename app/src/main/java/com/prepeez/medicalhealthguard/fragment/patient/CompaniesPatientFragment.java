...
public class CompaniesPatientFragment extends Fragment {
    ...
    public CompaniesPatientFragment() {
...
//                    Toast.makeText(getContext(), "Details Page", Toast.LENGTH_SHORT).show();
    ...
    public static void populatePatients() {
        ...
        RealmResults<RealmPatient> results = realm.where(RealmPatient.class).equalTo("grouptype", "Company").findAll();
...
//    }
    ...
    static public void filter_companies(String search_txt) {
