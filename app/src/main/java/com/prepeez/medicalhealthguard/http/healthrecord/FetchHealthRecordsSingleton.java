...
public class FetchHealthRecordsSingleton {
    private GetHealthRecordsInterface healthRecordInterface = null;

    public GetHealthRecordsInterface getHRecordsInterface() {
        ...
        if (healthRecordInterface == null){
            ...
            healthRecordInterface = retrofit.create(GetHealthRecordsInterface.class);
